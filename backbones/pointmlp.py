# Source: https://github.com/ma-xu/pointMLP-pytorch/blob/main/classification_ModelNet40/models/pointmlp.py (Apache License 2.0)
...
if __name__ == '__main__':
    data = torch.rand(2, 1024, 3).to('cuda:3')
    print("===> testing pointMLP ...")
    model = pointMLP().to('cuda:3')
    out = model(data)
    print(out.shape)
